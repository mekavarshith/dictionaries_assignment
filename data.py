...
# Convert the list of menu items to a list of dictionaries with random stock for non-drinks
import random
...
for item in menu_items:
    ...
    if code in drink_items:
        stock = random.randint(5000,10000)  # Random stock for non-drink items  # Assuming drinks have unlimited stock
    else:
